                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    <li><a href="/welcome">Bosh sahifa</a></li>
                                    <li><a href="/about">Biz haqimizda</a></li>
                                    <li><a href="/service">Xizmat</a></li>
                                    <li><a href="/blog">Xodimlar</a>
                                        <ul class="submenu">
                                            <li><a href="/blog">Qulayiklar</a></li>
                                            <li><a href="/single-blog">Xabarlar</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="/room">Xonalar</a>
                                    </li>
                    ...
                    <div class="col-xl-2 col-lg-2">
                        ...
                        <div class="header-btn">
                            <a href="book" class="btn btn1 d-none d-lg-block ">Onlayn buyurtma
                            </a>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
